...
public class RobotMap {
    ...
    public static double kMaxAccelerationPerSecond = 11.25; //TODO: Have Tomas check these
    public static double kMaxVelocityPerSecond = 40.833333334;
    ...
    public static final int CAN_INTAKE = 10; //11
