...
public class IntakeInterrupter extends CommandBase {
    // defining an instance to be used throughout the command and to be instantiated in the constructor of type parameter
    private final Intake m_subsystem; //TODO: rename this to the subsystem this is assigned to

    private IntakeIn toBeCanceled;

    public IntakeInterrupter(Intake subsystem, IntakeIn toBeCanceled) {
    ...
    public void initialize() {
        CommandScheduler.getInstance().cancel(toBeCanceled);
    }
