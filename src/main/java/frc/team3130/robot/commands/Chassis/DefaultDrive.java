...
public class DefaultDrive implements Command {
    ...
    private NetworkTableEntry driveSensitivity =
            tab.add("sensitivity", 1.0)
                    .getEntry();
    ...
    @Override
    public void execute() {
        double moveSpeed = -OI.driverGamepad.getRawAxis(1) * driveSensitivity.getDouble(1.0) ; //joystick's y axis is inverted
